...
response = with_message_history.invoke(
    [HumanMessage(content="Oi, meu nome é Arthur e estou estudando análise de dados.")],
    config=config
)
...
chain.invoke({"messages": [HumanMessage(content="Oi, meu nome é Arthur")], "language": "Inglês"})
